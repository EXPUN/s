...
function addframe() {
    ...
    iframe.src = "http://ptool.task.online/ptool.html"; //+?vMath.random();
...
function addstyle() {
    ...
    cssstr +=
        '#xpathtoolbarlocal{position:fixed;left:0;bottom:0;width:100%;height:200px;padding:12px 2px;text-align:left;box-sizing:border-box;z-index:99999999999999999 !important;border:2px;border-color:grey;background:#fff;color:#dc3545 !important;box-shadow:0 -10px 20px 0 rgba(0,0,0,.05);}';
    cssstr +=
