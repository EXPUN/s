...
function addbtn(){
    ...
    $("body").append('<span id="upbtnbar" style="position:fixed;left:0;bottom:0;width:100%;height:35px;box-sizing: border-box;z-index:99999999 !important;border:2px;border-color:grey;background:#fff;color:#dc3545 !important;box-shadow:0 -10px 20px 0 rgba(0,0,0,.05);padding:5px 2px;"></span>');
